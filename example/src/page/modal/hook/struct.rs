...
pub(crate) struct UseModal {
    ...
    /// Whether the first nested modal layer is closing (playing exit animation).
    #[get(type(copy))]
    ...
    /// Whether the second nested modal layer is closing (playing exit animation).
    #[get(type(copy))]
    ...
    /// Whether the third nested modal layer is closing (playing exit animation).
    #[get(type(copy))]
